    ...
    <ScrollView>
      <View>
        ...
        {expoPushToken && (
          <View>
            <Button
              onPress={() => modifyWeatherSubscription(expoPushToken, !isSubscribed, setIsSubscribed)}
              title={isSubscribed ? 'Unsubscribe' : 'Subscribe'}
            />
            <Button onPress={() => testSubscription(expoPushToken)} title="Send it now" />
          </View>
        )}
      ...
      <View>
        ...
        {notification ? (
          <>
            ...
            <Button onPress={() => setNotification(undefined)} title="Clear notification" />
          </>
        ) : (
          <Text>-</Text>
        )}
